...
var run = function(container_id, opts) {
  if (!opts) opts = {}

  var container_id = container_id
  var request = docker(opts.host, {version:'v1.30'})
  ...
  //==========use get() instead of using create ========
  var get = function(id, cb) {
    debug('getting an existing container')
    request.get('/containers/'+id +'/json', {json: {}}, cb)
  }
  //=======================end get====================
  ...
  //here, use get function to get an existing container
  get(container_id, function(err, container) {

...
import get_functions, modify_functions
import bridge
import dpdk
    ...
    def GetData(self, request, context):
        ...
        if request.command == 'hugepages':
            if request.str_request == 'total':
                ...
                response.int_response = get_functions.get_hugepage_totalmem_kB()
            elif request.str_request == 'free':
                response.header = "Total free hugepage memory in kB"
                response.int_response = get_functions.get_hugepage_freemem_kB()
